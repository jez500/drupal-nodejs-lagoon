 ...
 */
settings = {
    scheme: '${NODE_SCHEME:-http}',
    port: 8080,
    host: '0.0.0.0',
    resource: '${NODE_RESOURCE:-/socket.io}',
    serviceKey: '${NODE_SERVICE_KEY:-}',
    backend: {
        port: '${NODE_BACKEND_PORT:-8080}',
        host: '${NODE_BACKEND_HOST:-nginx}',
        scheme: '${NODE_BACKEND_SCHEME:-http}',
        basePath: '${NODE_BACKEND_BASE_PATH:-}',
        messagePath: '${NODE_MESSAGE_PATH:-/nodejs/message}'
    },
    debug: ${NODE_DEBUG:-false},
    sslKeyPath: '${NODE_SSL_KEY_PATH:-}',
    sslCertPath: '${NODE_SSL_CERT_PATH:-}',
    sslCAPath: '${NODE_SSL_CA_PATH:-}',
    baseAuthPath: '${NODE_BASE_AUTH_PATH:-/nodejs/}',
    extensions: [],
    clientsCanWriteToChannels: ${NODE_CLIENTS_CAN_WRITE_TO_CHANNELS:-false},
    clientsCanWriteToClients: ${NODE_CLIENTS_CAN_WRITE_TO_CLIENTS:-false},
    transports: ['websocket', 'polling'],
    jsMinification: ${NODE_JS_MINIFICATION:-true},
    jsEtag: ${NODE_JS_ETAG:-true},
    logLevel: ${NODE_LOG_LEVEL:-1}
};